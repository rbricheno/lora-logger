...
var rootCmd = &cobra.Command{
	...
	> source & copyright information: https://github.com/brocaar/loralogger/`,
	RunE: run,
}
...
func initConfig() {
	...
	if cfgFile != "" {
		...
		viper.SetConfigName("loralogger")
		viper.AddConfigPath(".")
		viper.AddConfigPath("$HOME/./config/loralogger")
		viper.AddConfigPath("/etc/loralogger")
